...
namespace Xin.ExternalService.EC.EB
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.example.org/Ec/", ConfigurationName="Xin.ExternalService.EC.EB.Ec")]
    public interface Ec
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.example.org/Ec/callService", ReplyAction="*")]
        System.Threading.Tasks.Task<Xin.ExternalService.EC.EB.callServiceResponse> callServiceAsync(Xin.ExternalService.EC.EB.callServiceRequest request);
    }
    ...
    public partial class callServiceRequest
    {
        ...
        public Xin.ExternalService.EC.EB.callServiceRequestBody Body;
        
        public callServiceRequest()
        {
        }
        
        public callServiceRequest(Xin.ExternalService.EC.EB.callServiceRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class callServiceRequestBody
    {
        ...
        public callServiceRequestBody(string paramsJson, string userName, string userPass, string service)
        {
    ...
    public partial class callServiceResponse
    {
        ...
        public Xin.ExternalService.EC.EB.callServiceResponseBody Body;
        
        public callServiceResponse()
        {
        }
        
        public callServiceResponse(Xin.ExternalService.EC.EB.callServiceResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface EcChannel : Xin.ExternalService.EC.EB.Ec, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class EcClient : System.ServiceModel.ClientBase<Xin.ExternalService.EC.EB.Ec>, Xin.ExternalService.EC.EB.Ec
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Xin.ExternalService.EC.EB.callServiceResponse> Xin.ExternalService.EC.EB.Ec.callServiceAsync(Xin.ExternalService.EC.EB.callServiceRequest request)
        {
            return base.Channel.callServiceAsync(request);
        }
        
        public System.Threading.Tasks.Task<Xin.ExternalService.EC.EB.callServiceResponse> callServiceAsync(string paramsJson, string userName, string userPass, string service)
        {
            Xin.ExternalService.EC.EB.callServiceRequest inValue = new Xin.ExternalService.EC.EB.callServiceRequest();
            inValue.Body = new Xin.ExternalService.EC.EB.callServiceRequestBody();
            inValue.Body.paramsJson = paramsJson;
            inValue.Body.userName = userName;
            inValue.Body.userPass = userPass;
            inValue.Body.service = service;
            return ((Xin.ExternalService.EC.EB.Ec)(this)).callServiceAsync(inValue);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.EcSOAP))
            {
                return new System.ServiceModel.EndpointAddress("http://longqi-eb.eccang.com/default/svc-open/web-service-v2");
            }
            throw new System.InvalidOperationException(string.Format("找不到名称为“{0}”的终结点。", endpointConfiguration));
        }
