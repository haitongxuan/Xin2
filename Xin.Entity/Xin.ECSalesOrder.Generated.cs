...
namespace Xin.Entities
{
    public partial class ECSalesOrder {
        ...
        public ECSalesOrder()
        {
            this.ECSalesOrderDetails = new List<ECSalesOrderDetail>();
            OnCreated();
        }
        ...
        public virtual ECSalesOrderAddress ECSalesOrderAddress
        {
            get;
            set;
        }

        public virtual ECOrderConfigData ECOrderConfigData
        {
            get;
            set;
        }

        public virtual ECWarehouse ECWarehouse
        {
            get;
            set;
        }

        public virtual IList<ECSalesOrderDetail> ECSalesOrderDetails
        {
            get;
            set;
        }
