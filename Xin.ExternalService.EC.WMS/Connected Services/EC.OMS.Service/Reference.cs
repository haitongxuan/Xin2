...
namespace EC.OMS.Service
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.example.org/Ec/", ConfigurationName="EC.OMS.Service.Ec")]
    public interface Ec
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.example.org/Ec/callService", ReplyAction="*")]
        System.Threading.Tasks.Task<EC.OMS.Service.callServiceResponse> callServiceAsync(EC.OMS.Service.callServiceRequest request);
    }
    ...
    public partial class callServiceRequest
    {
        ...
        public EC.OMS.Service.callServiceRequestBody Body;
        
        public callServiceRequest()
        {
        }
        
        public callServiceRequest(EC.OMS.Service.callServiceRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class callServiceResponse
    {
        ...
        public EC.OMS.Service.callServiceResponseBody Body;
        
        public callServiceResponse()
        {
        }
        
        public callServiceResponse(EC.OMS.Service.callServiceResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface EcChannel : EC.OMS.Service.Ec, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class EcClient : System.ServiceModel.ClientBase<EC.OMS.Service.Ec>, EC.OMS.Service.Ec
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<EC.OMS.Service.callServiceResponse> EC.OMS.Service.Ec.callServiceAsync(EC.OMS.Service.callServiceRequest request)
        {
            return base.Channel.callServiceAsync(request);
        }
        
        public System.Threading.Tasks.Task<EC.OMS.Service.callServiceResponse> callServiceAsync(string paramsJson, string appToken, string appKey, string service)
        {
            EC.OMS.Service.callServiceRequest inValue = new EC.OMS.Service.callServiceRequest();
            inValue.Body = new EC.OMS.Service.callServiceRequestBody();
            inValue.Body.paramsJson = paramsJson;
            inValue.Body.appToken = appToken;
            inValue.Body.appKey = appKey;
            inValue.Body.service = service;
            return ((EC.OMS.Service.Ec)(this)).callServiceAsync(inValue);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.EcSOAP))
            {
                return new System.ServiceModel.EndpointAddress("http://longqi.oms.yunwms.com/default/svc/web-service");
            }
            throw new System.InvalidOperationException(string.Format("找不到名称为“{0}”的终结点。", endpointConfiguration));
        }
