...
namespace Xin.Service.Context
{
    ...
    public partial class XinDBContext : DbContext,IEntityContext
    {
        ...
        public List<CwAccountQuerySpResult> CwAccountQuerySp (string PlateForm, string StoreName, string WareHouseDesc, string ProductSku, string ProcutCategoryName1, string ProcutCategoryName2, string OrderType, string Status, string RefNo, int? PageIndex, int? PageSize)
        {
            ...
            try 
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    ...
                    DbParameter PageIndexParameter = cmd.CreateParameter();
                    PageIndexParameter.ParameterName = "PageIndex";
                    PageIndexParameter.Direction = ParameterDirection.Input;
                    PageIndexParameter.DbType = DbType.Int32;
                    PageIndexParameter.Precision = 10;
                    PageIndexParameter.Scale = 0;
                    if (PageIndex.HasValue)
                    {
                        PageIndexParameter.Value = PageIndex.Value;
                    }
                    else
                    {
                        PageIndexParameter.Size = -1;
                        PageIndexParameter.Value = DBNull.Value;
                    }
                    cmd.Parameters.Add(PageIndexParameter);

                    DbParameter PageSizeParameter = cmd.CreateParameter();
                    PageSizeParameter.ParameterName = "PageSize";
                    PageSizeParameter.Direction = ParameterDirection.Input;
                    PageSizeParameter.DbType = DbType.Int32;
                    PageSizeParameter.Precision = 10;
                    PageSizeParameter.Scale = 0;
                    if (PageSize.HasValue)
                    {
                        PageSizeParameter.Value = PageSize.Value;
                    }
                    else
                    {
                        PageSizeParameter.Size = -1;
                        PageSizeParameter.Value = DBNull.Value;
                    }
                    cmd.Parameters.Add(PageSizeParameter);
        ...
        public async Task<List<CwAccountQuerySpResult>> CwAccountQuerySpAsync (string PlateForm, string StoreName, string WareHouseDesc, string ProductSku, string ProcutCategoryName1, string ProcutCategoryName2, string OrderType, string Status, string RefNo, int? PageIndex, int? PageSize)
        {
