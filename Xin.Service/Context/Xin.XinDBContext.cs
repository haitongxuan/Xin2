...
namespace Xin.Service.Context
{
    ...
    public partial class XinDBContext : DbContext,IEntityContext
    {
        ...
        #region ECSalesOrder Navigation properties
            ...
            modelBuilder.Entity<ECSalesOrder>().HasOne(x => x.Warehouse).WithMany(op => op.SalesOrders).IsRequired(false).HasForeignKey(@"WarehouseId");
            modelBuilder.Entity<ECSalesOrder>().HasMany(x => x.SalesOrderDetails).WithOne(op => op.ECSalesOrder).IsRequired(false).HasForeignKey(@"OrderId");
        ...
        #region ECWarehouse Navigation properties
            ...
            modelBuilder.Entity<ECWarehouse>().HasMany(x => x.SalesOrders).WithOne(op => op.Warehouse).IsRequired(false).HasForeignKey(@"WarehouseId");

        #endregion

        #region ECSalesOrderDetail Navigation properties

            modelBuilder.Entity<ECSalesOrderDetail>().HasOne(x => x.ECSalesOrder).WithMany(op => op.SalesOrderDetails).IsRequired(false).HasForeignKey(@"OrderId");
