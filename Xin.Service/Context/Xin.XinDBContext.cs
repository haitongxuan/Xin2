...
namespace Xin.Service.Context
{
    ...
    public partial class XinDBContext : DbContext,IEntityContext
    {
        ...
        private void ResRoleMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ResRole>().Property<bool>(@"StopFlag").HasColumnName(@"StopFlag").IsRequired().ValueGeneratedNever();
        ...
        private void ResResourceMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ResResource>().Property<bool>(@"StopFlag").HasColumnName(@"StopFlag").IsRequired().ValueGeneratedNever();
        ...
        private void ResPermissionMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ResPermission>().Property<bool>(@"StopFlag").HasColumnName(@"StopFlag").IsRequired().ValueGeneratedNever();
        ...
        private void ResScheduleMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ResSchedule>().Property<bool>(@"StopFlag").HasColumnName(@"StopFlag").IsRequired().ValueGeneratedNever();
        ...
        private void ECReceivingDetailMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECReceivingDetail>().Property<string>(x => x.ReferenceNo).HasColumnName(@"ReferenceNo").IsRequired().ValueGeneratedNever().HasMaxLength(64);
            modelBuilder.Entity<ECReceivingDetail>().Property<string>(x => x.WarehouseId).HasColumnName(@"WarehouseId").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECReceivingDetail>().Property<string>(x => x.ToWarehouseId).HasColumnName(@"ToWarehouseId").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECReceivingDetail>().Property<string>(x => x.WarehouseCode).HasColumnName(@"WarehouseCode").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECReceivingDetail>().Property<string>(x => x.lcCode).HasColumnName(@"lcCode").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECReceivingDetail>().Property<int>(x => x.AddUser).HasColumnName(@"AddUser").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECReceivingDetail>().Property<int>(x => x.ReceivingAddUser).HasColumnName(@"ReceivingAddUser").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECReceivingDetail>().Property<string>(x => x.ApplicationCode).HasColumnName(@"ApplicationCode").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECReceivingDetail>().Property<string>(x => x.ProductBarcode).HasColumnName(@"ProductBarcode").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECReceivingDetail>().Property<string>(x => x.ProductTitle).HasColumnName(@"ProductTitle").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECReceivingDetail>().Property<string>(x => x.PuCode).HasColumnName(@"PuCode").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECReceivingDetail>().Property<int>(x => x.ContainBattery).HasColumnName(@"ContainBattery").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECReceivingDetail>().Property<int>(x => x.ProductIsQc).HasColumnName(@"ProductIsQc").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECReceivingDetail>().Property<int>(x => x.IsImitation).HasColumnName(@"IsImitation").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECReceivingDetail>().Property<int>(x => x.IsExpDate).HasColumnName(@"IsExpDate").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECReceivingDetail>().Property<System.DateTime>(x => x.ExpDate).HasColumnName(@"ExpDate").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ECReceivingDetail>().Property<int>(x => x.Category1).HasColumnName(@"Category1").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECReceivingDetail>().Property<int>(x => x.Category2).HasColumnName(@"Category2").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECReceivingDetail>().Property<int>(x => x.Category3).HasColumnName(@"Category3").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECReceivingDetail>().Property<string>(x => x.WarehouseProductBarcode).HasColumnName(@"WarehouseProductBarcode").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECReceivingDetail>().Property<string>(x => x.SupplierCode).HasColumnName(@"SupplierCode").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECReceivingDetail>().Property<string>(x => x.PoCode).HasColumnName(@"PoCode").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECReceivingDetail>().Property<System.DateTime>(x => x.PoRelease).HasColumnName(@"PoRelease").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ECReceivingDetail>().Property<int>(x => x.IsReturned).HasColumnName(@"IsReturned").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECReceivingDetail>().Property<int>(x => x.ReceivingReturnedQty).HasColumnName(@"ReceivingReturnedQty").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECReceivingDetail>().Property<int>(x => x.QcReturnedQty).HasColumnName(@"QcReturnedQty").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECReceivingDetail>().Property<int>(x => x.Quantity).HasColumnName(@"Quantity").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECReceivingDetail>().Property<double>(x => x.OrgUnitPrice).HasColumnName(@"OrgUnitPrice").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ECReceivingDetail>().Property<double>(x => x.UnitPrice).HasColumnName(@"UnitPrice").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ECReceivingDetail>().Property<int>(x => x.ShippingFee).HasColumnName(@"ShippingFee").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECReceivingDetail>().Property<double>(x => x.TariffFee).HasColumnName(@"TariffFee").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ECReceivingDetail>().Property<double>(x => x.UnitPurchaseShipFee).HasColumnName(@"UnitPurchaseShipFee").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ECReceivingDetail>().Property<double>(x => x.UnitPurchaseTaxationFee).HasColumnName(@"UnitPurchaseTaxationFee").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ECReceivingDetail>().Property<double>(x => x.Total).HasColumnName(@"Total").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ECReceivingDetail>().Property<System.DateTime>(x => x.AddTime).HasColumnName(@"AddTime").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ECReceivingDetail>().Property<string>(x => x.ReceivingDescription).HasColumnName(@"ReceivingDescription").IsRequired().ValueGeneratedNever().HasMaxLength(1024);
        ...
        private void ECDeliveryDetailMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECDeliveryDetail>().Property<string>(@"IlId").HasColumnName(@"IlId").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECDeliveryDetail>().Property<string>(@"ReferenceNo").HasColumnName(@"ReferenceNo").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECDeliveryDetail>().Property<string>(@"WarehouseId").HasColumnName(@"WarehouseId").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECDeliveryDetail>().Property<string>(@"ToWarehouseId").HasColumnName(@"ToWarehouseId").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECDeliveryDetail>().Property<string>(@"WarehouseCode").HasColumnName(@"WarehouseCode").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECDeliveryDetail>().Property<string>(@"IcCode").HasColumnName(@"IcCode").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECDeliveryDetail>().Property<string>(x => x.UserId).HasColumnName(@"UserId").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECDeliveryDetail>().Property<string>(x => x.ApplicationCode).HasColumnName(@"ApplicationCode").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECDeliveryDetail>().Property<int>(x => x.CuType).HasColumnName(@"CuType").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECDeliveryDetail>().Property<string>(x => x.ProductBarcode).HasColumnName(@"ProductBarcode").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECDeliveryDetail>().Property<string>(x => x.ProductTitle).HasColumnName(@"ProductTitle").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECDeliveryDetail>().Property<int>(x => x.Category1).HasColumnName(@"Category1").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECDeliveryDetail>().Property<int>(x => x.Category2).HasColumnName(@"Category2").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECDeliveryDetail>().Property<int>(x => x.Category3).HasColumnName(@"Category3").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECDeliveryDetail>().Property<string>(x => x.WarehouseProductBarcode).HasColumnName(@"WarehouseProductBarcode").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECDeliveryDetail>().Property<string>(x => x.SupplierCode).HasColumnName(@"SupplierCode").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECDeliveryDetail>().Property<int>(x => x.Quantity).HasColumnName(@"Quantity").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECDeliveryDetail>().Property<double>(x => x.OrgUnitPrice).HasColumnName(@"OrgUnitPrice").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ECDeliveryDetail>().Property<double>(x => x.UnitPrice).HasColumnName(@"UnitPrice").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ECDeliveryDetail>().Property<int>(x => x.ShippingFee).HasColumnName(@"ShippingFee").IsRequired().ValueGeneratedNever().HasMaxLength(11);
            modelBuilder.Entity<ECDeliveryDetail>().Property<double>(x => x.Tariff_Fee).HasColumnName(@"Tariff_Fee").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ECDeliveryDetail>().Property<double>(x => x.UnitPurchaseShipFee).HasColumnName(@"UnitPurchaseShipFee").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ECDeliveryDetail>().Property<double>(x => x.unitPurchaseTaxationFee).HasColumnName(@"unitPurchaseTaxationFee").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ECDeliveryDetail>().Property<double>(x => x.Total).HasColumnName(@"Total").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ECDeliveryDetail>().Property<System.DateTime>(x => x.AddTime).HasColumnName(@"AddTime").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<ECDeliveryDetail>().Property<string>(x => x.SystemRemark).HasColumnName(@"SystemRemark").IsRequired().ValueGeneratedNever().HasMaxLength(1024);
            modelBuilder.Entity<ECDeliveryDetail>().Property<string>(x => x.Remark).HasColumnName(@"Remark").IsRequired().ValueGeneratedNever().HasMaxLength(1024);
            modelBuilder.Entity<ECDeliveryDetail>().Property<string>(x => x.ProductRemark).HasColumnName(@"ProductRemark").IsRequired().ValueGeneratedNever().HasMaxLength(1024);
            modelBuilder.Entity<ECDeliveryDetail>().Property<string>(x => x.RefNo).HasColumnName(@"RefNo").IsRequired().ValueGeneratedNever().HasMaxLength(200);
        ...
        private void ECRMARefundMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECRMARefund>().Property<string>(@"CreateDate").HasColumnName(@"CreateDate").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(@"RefNo").HasColumnName(@"RefNo").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(@"WarehouseRefNo").HasColumnName(@"WarehouseRefNo").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(@"Reason").HasColumnName(@"Reason").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(@"TransId").HasColumnName(@"TransId").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(@"CreateUser").HasColumnName(@"CreateUser").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.Note).HasColumnName(@"Note").IsRequired().ValueGeneratedNever().HasMaxLength(1024);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.FinancialNote).HasColumnName(@"FinancialNote").IsRequired().ValueGeneratedNever().HasMaxLength(1024);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.VerifyDate).HasColumnName(@"VerifyDate").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.VerifyUser).HasColumnName(@"VerifyUser").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.UserAccount).HasColumnName(@"UserAccount").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.UserAccountName).HasColumnName(@"UserAccountName").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.RefrenceNoPlatform).HasColumnName(@"RefrenceNoPlatform").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.RmaRefrenceNoPlatform).HasColumnName(@"RmaRefrenceNoPlatform").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.WarehouseShipDate).HasColumnName(@"WarehouseShipDate").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.Country).HasColumnName(@"Country").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.Site).HasColumnName(@"Site").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.WarehousId).HasColumnName(@"WarehousId").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.ShippingMethod).HasColumnName(@"ShippingMethod").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.OperatorNote).HasColumnName(@"OperatorNote").IsRequired().ValueGeneratedNever().HasMaxLength(1024);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.CustomerServiceNote).HasColumnName(@"CustomerServiceNote").IsRequired().ValueGeneratedNever().HasMaxLength(1024);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.ProductSku).HasColumnName(@"ProductSku").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.SaleUser).HasColumnName(@"SaleUser").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.ProductTitle).HasColumnName(@"ProductTitle").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.Qty).HasColumnName(@"Qty").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.PcLike).HasColumnName(@"PcLike").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.PcName).HasColumnName(@"PcName").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.PayRefId).HasColumnName(@"PayRefId").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.RefundType).HasColumnName(@"RefundType").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.AmountRefund).HasColumnName(@"AmountRefund").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.AmountPaid).HasColumnName(@"AmountPaid").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.AmountOrder).HasColumnName(@"AmountOrder").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.Currency).HasColumnName(@"Currency").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.BuyerId).HasColumnName(@"BuyerId").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.RefundDate).HasColumnName(@"RefundDate").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.Status).HasColumnName(@"Status").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.RefundStep).HasColumnName(@"RefundStep").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.RefundDataSource).HasColumnName(@"RefundDataSource").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECRMARefund>().Property<string>(x => x.SyncMessage).HasColumnName(@"SyncMessage").IsRequired().ValueGeneratedNever().HasMaxLength(1024);
