...
namespace Xin.Service.Context
{
    ...
    public partial class XinDBContext : DbContext,IEntityContext
    {
        ...
        public virtual DbSet<ECInventoryBatch> ECInventoryBatches
        {
            get;
            set;
        }

        public virtual DbSet<ECTransitBatchNumber> ECTransitBatchNumbers
        {
            get;
            set;
        }

        public virtual DbSet<DingClassify> DingClassifies
        {
            get;
            set;
        }

        public virtual DbSet<DingNew> DingNews
        {
            get;
            set;
        }

        public virtual DbSet<OmsOrderList> OmsOrderLists
        {
            get;
            set;
        }

        public virtual DbSet<OmsOrderListFeeSummery> OmsOrderListFeeSummeries
        {
            get;
            set;
        }

        public virtual DbSet<OmsOrderListInventoryBatchOut> OmsOrderListInventoryBatchOuts
        {
            get;
            set;
        }

        public virtual DbSet<OmsOrderListItem> OmsOrderListItems
        {
            get;
            set;
        }

        public virtual DbSet<OmsOrderListOrderFee> OmsOrderListOrderFees
        {
            get;
            set;
        }

        public virtual DbSet<ECCurrency> ECCurrencies
        {
            get;
            set;
        }

        public virtual DbSet<DingClass> DingClasses
        {
            get;
            set;
        }
        ...
        public List<CwAccountQuerySpResult> CwAccountQuerySp (string whereSql)
        {
            ...
            try 
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    ...
                    DbParameter whereSqlParameter = cmd.CreateParameter();
                    whereSqlParameter.ParameterName = "whereSql";
                    whereSqlParameter.Direction = ParameterDirection.Input;
                    whereSqlParameter.DbType = DbType.String;
                    whereSqlParameter.Size = 4000;
                    if (whereSql != null)
                    {
                        whereSqlParameter.Value = whereSql;
                    }
                    else
                    {
                        whereSqlParameter.Value = DBNull.Value;
                    }
                    cmd.Parameters.Add(whereSqlParameter);
        ...
        public async Task<List<CwAccountQuerySpResult>> CwAccountQuerySpAsync (string whereSql)
        {
            ...
            try 
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    if (this.Database.GetCommandTimeout().HasValue)
                        cmd.CommandTimeout = this.Database.GetCommandTimeout().Value;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandText = @"dbo.DealRepeatCust_sp";
                    cmd.ExecuteNonQuery();
                }
            }
            finally
        ...
        public async Task DealRepeatCustSpAsync ()
        {
        ...
        public void InsertStorageLocationCodeSp (string KK, int? qty)
        {
            ...
            try 
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    if (this.Database.GetCommandTimeout().HasValue)
                        cmd.CommandTimeout = this.Database.GetCommandTimeout().Value;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.CommandText = @"dbo.InsertStorageLocationCode_sp";

                    DbParameter KKParameter = cmd.CreateParameter();
                    KKParameter.ParameterName = "KK";
                    KKParameter.Direction = ParameterDirection.Input;
                    KKParameter.DbType = DbType.String;
                    KKParameter.Size = 20;
                    if (KK != null)
                    {
                        KKParameter.Value = KK;
                    }
                    else
                    {
                        KKParameter.Value = DBNull.Value;
                    }
                    cmd.Parameters.Add(KKParameter);

                    DbParameter qtyParameter = cmd.CreateParameter();
                    qtyParameter.ParameterName = "qty";
                    qtyParameter.Direction = ParameterDirection.Input;
                    qtyParameter.DbType = DbType.Int32;
                    qtyParameter.Precision = 10;
                    qtyParameter.Scale = 0;
                    if (qty.HasValue)
                    {
                        qtyParameter.Value = qty.Value;
                    }
                    else
                    {
                        qtyParameter.Size = -1;
                        qtyParameter.Value = DBNull.Value;
                    }
        ...
        public async Task InsertStorageLocationCodeSpAsync (string KK, int? qty)
        {
        ...
        public List<TCResult> TC (string tableName)
        {

            List<TCResult> result = new List<TCResult>();
            DbConnection connection = this.Database.GetDbConnection();
            bool needClose = false;
            if (connection.State != ConnectionState.Open)
            {
            ...
            try 
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    if (this.Database.GetCommandTimeout().HasValue)
                        cmd.CommandTimeout = this.Database.GetCommandTimeout().Value;
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = @"select * from dbo.TC(@tableName)";
                    ...
                    using (IDataReader reader = cmd.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
                            TCResult row = new TCResult();
                            if (fieldNames.Contains("tableName") && !reader.IsDBNull(reader.GetOrdinal("tableName")))
                                row.TableName = (string)Convert.ChangeType(reader.GetValue(reader.GetOrdinal(@"tableName")), typeof(string));
                            else
                                row.TableName = null;

                            if (fieldNames.Contains("ColumnsList") && !reader.IsDBNull(reader.GetOrdinal("ColumnsList")))
                                row.ColumnsList = (string)Convert.ChangeType(reader.GetValue(reader.GetOrdinal(@"ColumnsList")), typeof(string));
                            else
                                row.ColumnsList = null;

                            if (fieldNames.Contains("ParaList") && !reader.IsDBNull(reader.GetOrdinal("ParaList")))
                                row.ParaList = (string)Convert.ChangeType(reader.GetValue(reader.GetOrdinal(@"ParaList")), typeof(string));
                            else
                                row.ParaList = null;
        ...
        public async Task<List<TCResult>> TCAsync (string tableName)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            this.ECInventoryBatchMapping(modelBuilder);
            this.CustomizeECInventoryBatchMapping(modelBuilder);

            this.ECTransitBatchNumberMapping(modelBuilder);
            this.CustomizeECTransitBatchNumberMapping(modelBuilder);

            this.DingClassifyMapping(modelBuilder);
            this.CustomizeDingClassifyMapping(modelBuilder);

            this.DingNewMapping(modelBuilder);
            this.CustomizeDingNewMapping(modelBuilder);

            this.OmsOrderListMapping(modelBuilder);
            this.CustomizeOmsOrderListMapping(modelBuilder);

            this.OmsOrderListFeeSummeryMapping(modelBuilder);
            this.CustomizeOmsOrderListFeeSummeryMapping(modelBuilder);

            this.OmsOrderListInventoryBatchOutMapping(modelBuilder);
            this.CustomizeOmsOrderListInventoryBatchOutMapping(modelBuilder);

            this.OmsOrderListItemMapping(modelBuilder);
            this.CustomizeOmsOrderListItemMapping(modelBuilder);

            this.OmsOrderListOrderFeeMapping(modelBuilder);
            this.CustomizeOmsOrderListOrderFeeMapping(modelBuilder);

            this.ECCurrencyMapping(modelBuilder);
            this.CustomizeECCurrencyMapping(modelBuilder);

            this.DingClassMapping(modelBuilder);
            this.CustomizeDingClassMapping(modelBuilder);
        ...
        private void ECProductMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECProduct>().Property<decimal?>(x => x.ProductDeclaredValue).HasColumnName(@"ProductDeclaredValue").HasColumnType(@"decimal(18,4)").ValueGeneratedNever();
            ...
            modelBuilder.Entity<ECProduct>().Property<decimal?>(x => x.ProductWeight).HasColumnName(@"ProductWeight").HasColumnType(@"decimal(18,4)").ValueGeneratedNever();
            modelBuilder.Entity<ECProduct>().Property<decimal?>(x => x.ProductNetWeight).HasColumnName(@"ProductNetWeight").HasColumnType(@"decimal(18,4)").ValueGeneratedNever();
            ...
            modelBuilder.Entity<ECProduct>().Property<decimal?>(x => x.ProductLength).HasColumnName(@"ProductLength").HasColumnType(@"decimal(18,4)").ValueGeneratedNever();
            modelBuilder.Entity<ECProduct>().Property<decimal?>(x => x.ProductWidth).HasColumnName(@"ProductWidth").HasColumnType(@"decimal(18,4)").ValueGeneratedNever();
            modelBuilder.Entity<ECProduct>().Property<decimal?>(x => x.ProductHeight).HasColumnName(@"ProductHeight").HasColumnType(@"decimal(18,4)").ValueGeneratedNever();
            ...
            modelBuilder.Entity<ECProduct>().Property<string>(x => x.ProductImages).HasColumnName(@"ProductImages").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
            modelBuilder.Entity<ECProduct>().Property<int?>(x => x.DefaulBuyWarehouseId).HasColumnName(@"DefaulBuyWarehouseId").ValueGeneratedNever();
            modelBuilder.Entity<ECProduct>().Property<string>(x => x.LogisticAttribute).HasColumnName(@"LogisticAttribute").ValueGeneratedNever();
            modelBuilder.Entity<ECProduct>().Property<decimal?>(x => x.SuggestPrice).HasColumnName(@"SuggestPrice").HasColumnType(@"decimal(18,4)").ValueGeneratedNever();
            modelBuilder.Entity<ECProduct>().Property<string>(x => x.SuggestPriceCurrencyCode).HasColumnName(@"SuggestPriceCurrencyCode").ValueGeneratedNever();
        ...
        private void ECSalesOrderMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.Plateform).HasColumnName(@"Plateform").HasColumnType(@"nvarchar(1500)").ValueGeneratedNever().HasMaxLength(1500);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.OrderType).HasColumnName(@"OrderType").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
            ...
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.RefNo).HasColumnName(@"RefNo").HasColumnType(@"nvarchar(500)").ValueGeneratedNever().HasMaxLength(500);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.SaleOrderCode).HasColumnName(@"SaleOrderCode").HasColumnType(@"nvarchar(500)").ValueGeneratedNever().HasMaxLength(500);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.SysOrderCode).HasColumnName(@"SysOrderCode").HasColumnType(@"nvarchar(500)").ValueGeneratedNever().HasMaxLength(500);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.WarehouseOrderCode).HasColumnName(@"WarehouseOrderCode").HasColumnType(@"nvarchar(500)").ValueGeneratedNever().HasMaxLength(500);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.CompanyCode).HasColumnName(@"CompanyCode").HasColumnType(@"nvarchar(500)").ValueGeneratedNever().HasMaxLength(500);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.UserAccount).HasColumnName(@"UserAccount").HasColumnType(@"nvarchar(1500)").ValueGeneratedNever().HasMaxLength(1500);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.PlatformUserName).HasColumnName(@"PlatformUserName").HasColumnType(@"nvarchar(1500)").ValueGeneratedNever().HasMaxLength(1500);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.OldShippingMethod).HasColumnName(@"OldShippingMethod").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.OldShippingMethodNo).HasColumnName(@"OldShippingMethodNo").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.ShippingMethod).HasColumnName(@"ShippingMethod").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.ShippingMethodNo).HasColumnName(@"ShippingMethodNo").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.ShippingMethodPlatform).HasColumnName(@"ShippingMethodPlatform").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.WarehouseId).HasColumnName(@"WarehouseId").HasColumnType(@"nvarchar(1500)").ValueGeneratedNever().HasMaxLength(1500);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.WarehouseCode).HasColumnName(@"WarehouseCode").HasColumnType(@"nvarchar(500)").ValueGeneratedNever().HasMaxLength(500);
            ...
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.Currency).HasColumnName(@"Currency").HasColumnType(@"nvarchar(1500)").ValueGeneratedNever().HasMaxLength(1500);
            ...
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.BuyerId).HasColumnName(@"BuyerId").HasColumnType(@"nvarchar(500)").ValueGeneratedNever().HasMaxLength(500);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.BuyerName).HasColumnName(@"BuyerName").HasColumnType(@"nvarchar(500)").ValueGeneratedNever().HasMaxLength(500);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.BuyerMail).HasColumnName(@"BuyerMail").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.Site).HasColumnName(@"Site").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.CountryCode).HasColumnName(@"CountryCode").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
            ...
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.OrderDesc).HasColumnName(@"OrderDesc").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.PaypalTransactionId).HasColumnName(@"PaypalTransactionId").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.PaymentMethod).HasColumnName(@"PaymentMethod").HasColumnType(@"nvarchar(25)").ValueGeneratedNever().HasMaxLength(25);
            ...
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.AbnormalReason).HasColumnName(@"AbnormalReason").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
            modelBuilder.Entity<ECSalesOrder>().Property<int?>(@"AddressId").HasColumnName(@"AddressId").HasColumnType(@"int").ValueGeneratedNever();
            ...
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.SyncCode).HasColumnName(@"SyncCode").HasColumnType(@"nvarchar(500)").ValueGeneratedNever().HasMaxLength(500);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.IsPush).HasColumnName(@"is_push").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.CustomOrderType).HasColumnName(@"CustomOrderType").HasColumnType(@"nvarchar(500)").ValueGeneratedNever().HasMaxLength(500);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.IsMark).HasColumnName(@"IsMark").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.CustomerServiceNote).HasColumnName(@"CustomerServiceNote").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.DiscountVal).HasColumnName(@"discount_val").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrder>().Property<bool?>(x => x.NeedSendEmail).HasColumnName(@"needSendEmail").HasColumnType(@"bit").ValueGeneratedOnAdd().HasDefaultValueSql(@"0");
            modelBuilder.Entity<ECSalesOrder>().Property<bool?>(x => x.DeliverEmail).HasColumnName(@"deliverEmail").HasColumnType(@"bit").ValueGeneratedOnAdd().HasDefaultValueSql(@"0");
        ...
        private void ECSalesOrderAddressMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECSalesOrderAddress>().Property<int>(x => x.Id).HasColumnName(@"id").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity<ECSalesOrderAddress>().Property<string>(x => x.Name).HasColumnName(@"Name").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrderAddress>().Property<string>(x => x.CompanyName).HasColumnName(@"CompanyName").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrderAddress>().Property<string>(x => x.CountryCode).HasColumnName(@"CountryCode").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrderAddress>().Property<string>(x => x.CountryName).HasColumnName(@"CountryName").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrderAddress>().Property<string>(x => x.CityName).HasColumnName(@"CityName").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrderAddress>().Property<string>(x => x.PostalCode).HasColumnName(@"PostalCode").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrderAddress>().Property<string>(x => x.Line1).HasColumnName(@"Line1").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
            modelBuilder.Entity<ECSalesOrderAddress>().Property<string>(x => x.Line2).HasColumnName(@"Line2").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
            modelBuilder.Entity<ECSalesOrderAddress>().Property<string>(x => x.Line3).HasColumnName(@"Line3").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
            modelBuilder.Entity<ECSalesOrderAddress>().Property<string>(x => x.District).HasColumnName(@"District").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrderAddress>().Property<string>(x => x.State).HasColumnName(@"State").HasColumnType(@"nvarchar(500)").ValueGeneratedNever().HasMaxLength(500);
            modelBuilder.Entity<ECSalesOrderAddress>().Property<string>(x => x.Doorplate).HasColumnName(@"Doorplate").HasColumnType(@"nvarchar(500)").ValueGeneratedNever().HasMaxLength(500);
            modelBuilder.Entity<ECSalesOrderAddress>().Property<string>(x => x.Phone).HasColumnName(@"Phone").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            ...
            modelBuilder.Entity<ECSalesOrderAddress>().HasKey(@"Id");
        }
        ...
        private void ECSalesOrderDetailMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECSalesOrderDetail>().Property<string>(x => x.Sku).HasColumnName(@"Sku").HasColumnType(@"nvarchar(500)").ValueGeneratedNever().HasMaxLength(500);
            modelBuilder.Entity<ECSalesOrderDetail>().Property<string>(x => x.WarehouseSku).HasColumnName(@"WarehouseSku").HasColumnType(@"nvarchar(500)").ValueGeneratedNever().HasMaxLength(500);
            ...
            modelBuilder.Entity<ECSalesOrderDetail>().Property<string>(x => x.ProductTitle).HasColumnName(@"ProductTitle").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
            modelBuilder.Entity<ECSalesOrderDetail>().Property<string>(x => x.Pic).HasColumnName(@"Pic").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
            modelBuilder.Entity<ECSalesOrderDetail>().Property<string>(x => x.OpSite).HasColumnName(@"OpSite").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
            modelBuilder.Entity<ECSalesOrderDetail>().Property<string>(x => x.ProductUrl).HasColumnName(@"ProductUrl").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
            modelBuilder.Entity<ECSalesOrderDetail>().Property<string>(x => x.RefItemId).HasColumnName(@"RefItemId").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrderDetail>().Property<string>(x => x.OpRefItemLocation).HasColumnName(@"OpRefItemLocation").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrderDetail>().Property<string>(x => x.UnitFinalValueFee).HasColumnName(@"UnitFinalValueFee").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            ...
            modelBuilder.Entity<ECSalesOrderDetail>().Property<int>(x => x.Id).HasColumnName(@"id").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<ECSalesOrderDetail>().HasKey(@"Id");
        }
        ...
        private void ECDeliveryDetailMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECDeliveryDetail>().Property<decimal?>(x => x.ShippingFee).HasColumnName(@"ShippingFee").HasColumnType(@"money").ValueGeneratedNever().HasMaxLength(11);
        ...
        #region ECInventoryBatch Mapping

        private void ECInventoryBatchMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ECInventoryBatch>().ToTable(@"EC_InventoryBatch", @"dbo");
            modelBuilder.Entity<ECInventoryBatch>().Property<int>(x => x.Id).HasColumnName(@"id").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<ECInventoryBatch>().Property<int?>(x => x.WarehouseId).HasColumnName(@"warehouseId").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<ECInventoryBatch>().Property<string>(x => x.ProductSku).HasColumnName(@"productSku").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECInventoryBatch>().Property<string>(x => x.LcCode).HasColumnName(@"lcCode").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECInventoryBatch>().Property<int?>(x => x.IbQuantity).HasColumnName(@"ibQuantity").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<ECInventoryBatch>().Property<int?>(x => x.OutQuantity).HasColumnName(@"outQuantity").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<ECInventoryBatch>().Property<string>(x => x.ReferenceNo).HasColumnName(@"referenceNo").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECInventoryBatch>().Property<string>(x => x.RoCode).HasColumnName(@"roCode").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECInventoryBatch>().Property<string>(x => x.PoCode).HasColumnName(@"poCode").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECInventoryBatch>().Property<int?>(x => x.Status).HasColumnName(@"status").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<ECInventoryBatch>().Property<int?>(x => x.HoldStatus).HasColumnName(@"holdStatus").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<ECInventoryBatch>().Property<int?>(x => x.Type).HasColumnName(@"type").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<ECInventoryBatch>().Property<System.DateTime?>(x => x.FifoTime).HasColumnName(@"fifoTime").HasColumnType(@"datetime").ValueGeneratedNever();
            modelBuilder.Entity<ECInventoryBatch>().Property<System.DateTime?>(x => x.UpdateTime).HasColumnName(@"updateTime").HasColumnType(@"datetime").ValueGeneratedNever();
            modelBuilder.Entity<ECInventoryBatch>().Property<int?>(x => x.IsNeedDeclare).HasColumnName(@"isNeedDeclare").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<ECInventoryBatch>().HasKey(@"Id");
        }

        partial void CustomizeECInventoryBatchMapping(ModelBuilder modelBuilder);

        #endregion

        #region ECTransitBatchNumber Mapping

        private void ECTransitBatchNumberMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ECTransitBatchNumber>().ToTable(@"EC_TransitBatchNumber", @"dbo");
            modelBuilder.Entity<ECTransitBatchNumber>().Property<int>(x => x.Id).HasColumnName(@"id").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<ECTransitBatchNumber>().Property<int?>(x => x.WarehouseId).HasColumnName(@"warehouseId").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<ECTransitBatchNumber>().Property<string>(x => x.ProductSku).HasColumnName(@"productSku").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECTransitBatchNumber>().Property<string>(x => x.RoCode).HasColumnName(@"roCode").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECTransitBatchNumber>().Property<int?>(x => x.TransitBatchNumber).HasColumnName(@"transitBatchNumber").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<ECTransitBatchNumber>().HasKey(@"Id");
        }

        partial void CustomizeECTransitBatchNumberMapping(ModelBuilder modelBuilder);

        #endregion

        #region DingClassify Mapping

        private void DingClassifyMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DingClassify>().ToTable(@"Ding_Classify", @"dbo");
            modelBuilder.Entity<DingClassify>().Property<int>(x => x.Id).HasColumnName(@"id").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<DingClassify>().Property<string>(x => x.Name).HasColumnName(@"name").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<DingClassify>().Property<string>(x => x.Remark).HasColumnName(@"remark").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<DingClassify>().Property<int?>(@"ClassId").HasColumnName(@"class_id").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<DingClassify>().HasKey(@"Id");
        }

        partial void CustomizeDingClassifyMapping(ModelBuilder modelBuilder);

        #endregion

        #region DingNew Mapping

        private void DingNewMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DingNew>().ToTable(@"Ding_News", @"dbo");
            modelBuilder.Entity<DingNew>().Property<int>(x => x.Id).HasColumnName(@"id").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<DingNew>().Property<int?>(@"ClassifyId").HasColumnName(@"classify_id").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<DingNew>().Property<string>(x => x.OriginalContent).HasColumnName(@"original_content").HasColumnType(@"text").ValueGeneratedNever().HasMaxLength(2147483647);
            modelBuilder.Entity<DingNew>().Property<string>(x => x.HtmlContent).HasColumnName(@"html_content").HasColumnType(@"text").ValueGeneratedNever().HasMaxLength(2147483647);
            modelBuilder.Entity<DingNew>().Property<string>(x => x.Editer).HasColumnName(@"editer").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<DingNew>().Property<System.DateTime?>(x => x.CreateTime).HasColumnName(@"create_time").HasColumnType(@"datetime2").ValueGeneratedOnAdd().HasDefaultValueSql(@"getdate()");
            modelBuilder.Entity<DingNew>().Property<System.DateTime?>(x => x.UpdateTime).HasColumnName(@"update_time").HasColumnType(@"datetime2").ValueGeneratedNever();
            modelBuilder.Entity<DingNew>().Property<string>(x => x.Image).HasColumnName(@"image").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<DingNew>().Property<string>(x => x.Title).HasColumnName(@"title").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<DingNew>().Property<int?>(x => x.Status).HasColumnName(@"status").HasColumnType(@"int").ValueGeneratedNever().HasDefaultValueSql(@"0");
            modelBuilder.Entity<DingNew>().Property<string>(x => x.SubTitle).HasColumnName(@"sub_title").HasColumnType(@"text").ValueGeneratedNever().HasMaxLength(2147483647);
            modelBuilder.Entity<DingNew>().HasKey(@"Id");
        }

        partial void CustomizeDingNewMapping(ModelBuilder modelBuilder);

        #endregion

        #region OmsOrderList Mapping

        private void OmsOrderListMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<OmsOrderList>().ToTable(@"Oms_OrderList", @"dbo");
            modelBuilder.Entity<OmsOrderList>().Property<int>(x => x.Id).HasColumnName(@"id").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.CompanyCode).HasColumnName(@"company_code").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.OrderCode).HasColumnName(@"order_code").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ReferenceNo).HasColumnName(@"reference_no").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.Platform).HasColumnName(@"platform").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.OrderStatus).HasColumnName(@"order_status").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ShippingMethod).HasColumnName(@"shipping_method").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.TrackingNo).HasColumnName(@"tracking_no").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.WarehouseId).HasColumnName(@"warehouse_id").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.WarehouseCode).HasColumnName(@"warehouse_code").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.OrderDesc).HasColumnName(@"order_desc").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<System.DateTime?>(x => x.DateCreate).HasColumnName(@"date_create").HasColumnType(@"datetime").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderList>().Property<System.DateTime?>(x => x.DateRelease).HasColumnName(@"date_release").HasColumnType(@"datetime").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderList>().Property<System.DateTime?>(x => x.DateShipping).HasColumnName(@"date_shipping").HasColumnType(@"datetime").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderList>().Property<System.DateTime?>(x => x.DateModify).HasColumnName(@"date_modify").HasColumnType(@"datetime").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ConsigneeCountryCode).HasColumnName(@"consignee_country_code").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ConsigneeCountryName).HasColumnName(@"consignee_country_name").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ConsigneeState).HasColumnName(@"consignee_state").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ConsigneeCity).HasColumnName(@"consignee_city").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ConsigneeDistrict).HasColumnName(@"consignee_district").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ConsigneeStreet1).HasColumnName(@"consignee_street1").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ConsigneeStreet2).HasColumnName(@"consignee_street2").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ConsigneeStreet3).HasColumnName(@"consignee_street3").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ConsigneZipcode).HasColumnName(@"consigne_zipcode").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ConsigneeDoorplate).HasColumnName(@"consignee_doorplate").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ConsigneeCompany).HasColumnName(@"consignee_company").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ConsigneeName).HasColumnName(@"consignee_name").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ConsigneePhone).HasColumnName(@"consignee_phone").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ConsigneeEmail).HasColumnName(@"consignee_email").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.AbnormalReason).HasColumnName(@"abnormal_reason").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.CourierName).HasColumnName(@"courier_name").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.ChannelCode).HasColumnName(@"channel_code").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<int?>(x => x.IsOrderCod).HasColumnName(@"is_order_cod").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderList>().Property<string>(x => x.OrderCodCurrency).HasColumnName(@"order_cod_currency").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderList>().Property<decimal?>(x => x.OrderWeight).HasColumnName(@"order_weight").HasColumnType(@"money").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderList>().Property<decimal?>(x => x.OrderCodPrice).HasColumnName(@"order_cod_price").HasColumnType(@"money").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderList>().Property<int?>(@"FeeSummeryId").HasColumnName(@"fee_summery_id").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderList>().HasKey(@"Id");
        }

        partial void CustomizeOmsOrderListMapping(ModelBuilder modelBuilder);

        #endregion

        #region OmsOrderListFeeSummery Mapping

        private void OmsOrderListFeeSummeryMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<OmsOrderListFeeSummery>().ToTable(@"Oms_OrderListFeeSummery", @"dbo");
            modelBuilder.Entity<OmsOrderListFeeSummery>().Property<int>(x => x.Id).HasColumnName(@"id").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<OmsOrderListFeeSummery>().Property<string>(x => x.OrderCode).HasColumnName(@"order_code").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderListFeeSummery>().Property<string>(x => x.ShippingMethod).HasColumnName(@"shipping_method").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderListFeeSummery>().Property<string>(x => x.CountryCode).HasColumnName(@"country_code").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderListFeeSummery>().Property<double?>(x => x.OrderWeight).HasColumnName(@"order_weight").HasColumnType(@"float").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderListFeeSummery>().Property<string>(x => x.FeeStatus).HasColumnName(@"fee_status").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderListFeeSummery>().Property<System.DateTime?>(x => x.FeeTime).HasColumnName(@"fee_time").HasColumnType(@"datetime").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderListFeeSummery>().Property<double?>(x => x.ShipCost).HasColumnName(@"ship_cost").HasColumnType(@"float").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderListFeeSummery>().Property<double?>(x => x.OpCost).HasColumnName(@"op_cost").HasColumnType(@"float").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderListFeeSummery>().Property<double?>(x => x.FuelCost).HasColumnName(@"fuel_cost").HasColumnType(@"float").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderListFeeSummery>().Property<double?>(x => x.RegisterCost).HasColumnName(@"register_cost").HasColumnType(@"float").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderListFeeSummery>().Property<double?>(x => x.WarehouseCost).HasColumnName(@"warehouse_cost").HasColumnType(@"float").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderListFeeSummery>().Property<double?>(x => x.TariffCost).HasColumnName(@"tariff_cost").HasColumnType(@"float").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderListFeeSummery>().Property<double?>(x => x.IncidentalCost).HasColumnName(@"incidental_cost").HasColumnType(@"float").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderListFeeSummery>().HasKey(@"Id");
        }

        partial void CustomizeOmsOrderListFeeSummeryMapping(ModelBuilder modelBuilder);

        #endregion

        #region OmsOrderListInventoryBatchOut Mapping

        private void OmsOrderListInventoryBatchOutMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<OmsOrderListInventoryBatchOut>().ToTable(@"Oms_OrderListInventoryBatchOut", @"dbo");
            modelBuilder.Entity<OmsOrderListInventoryBatchOut>().Property<int>(x => x.Id).HasColumnName(@"id").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<OmsOrderListInventoryBatchOut>().Property<string>(x => x.ReceivingCode).HasColumnName(@"receiving_code").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderListInventoryBatchOut>().Property<string>(x => x.ProductBarcode).HasColumnName(@"product_barcode").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderListInventoryBatchOut>().Property<int?>(x => x.Quantity).HasColumnName(@"quantity").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderListInventoryBatchOut>().Property<int?>(@"OrderId").HasColumnName(@"order_id").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderListInventoryBatchOut>().HasKey(@"Id");
        }

        partial void CustomizeOmsOrderListInventoryBatchOutMapping(ModelBuilder modelBuilder);

        #endregion

        #region OmsOrderListItem Mapping

        private void OmsOrderListItemMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<OmsOrderListItem>().ToTable(@"Oms_OrderListItems", @"dbo");
            modelBuilder.Entity<OmsOrderListItem>().Property<int>(x => x.Id).HasColumnName(@"id").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<OmsOrderListItem>().Property<string>(x => x.ProductId).HasColumnName(@"product_id").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderListItem>().Property<string>(x => x.ProductSku).HasColumnName(@"product_sku").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderListItem>().Property<int?>(x => x.Quantity).HasColumnName(@"quantity").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderListItem>().Property<int?>(@"OrderId").HasColumnName(@"order_id").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderListItem>().HasKey(@"Id");
        }

        partial void CustomizeOmsOrderListItemMapping(ModelBuilder modelBuilder);

        #endregion

        #region OmsOrderListOrderFee Mapping

        private void OmsOrderListOrderFeeMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<OmsOrderListOrderFee>().ToTable(@"Oms_OrderListOrderFee", @"dbo");
            modelBuilder.Entity<OmsOrderListOrderFee>().Property<int>(x => x.Id).HasColumnName(@"id").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<OmsOrderListOrderFee>().Property<string>(x => x.Type).HasColumnName(@"type").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderListOrderFee>().Property<string>(x => x.CurrencyCode).HasColumnName(@"currency_code").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<OmsOrderListOrderFee>().Property<double?>(x => x.Amount).HasColumnName(@"amount").HasColumnType(@"float").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderListOrderFee>().Property<int?>(@"OrderId").HasColumnName(@"order_id").HasColumnType(@"int").ValueGeneratedNever();
            modelBuilder.Entity<OmsOrderListOrderFee>().HasKey(@"Id");
        }

        partial void CustomizeOmsOrderListOrderFeeMapping(ModelBuilder modelBuilder);

        #endregion

        #region ECCurrency Mapping

        private void ECCurrencyMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ECCurrency>().ToTable(@"EC_Currency", @"dbo");
            modelBuilder.Entity<ECCurrency>().Property<int>(x => x.Id).HasColumnName(@"id").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<ECCurrency>().Property<string>(x => x.CurrencyCode).HasColumnName(@"currency_code").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECCurrency>().Property<string>(x => x.CurrencyName).HasColumnName(@"currency_name").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECCurrency>().Property<string>(x => x.CurrencyNameEn).HasColumnName(@"currency_name_en").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECCurrency>().Property<decimal?>(x => x.CurrencyRate).HasColumnName(@"currency_rate").HasColumnType(@"money").ValueGeneratedNever();
            modelBuilder.Entity<ECCurrency>().HasKey(@"Id");
        }

        partial void CustomizeECCurrencyMapping(ModelBuilder modelBuilder);

        #endregion

        #region DingClass Mapping

        private void DingClassMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DingClass>().ToTable(@"Ding_Class", @"dbo");
            modelBuilder.Entity<DingClass>().Property<int>(x => x.Id).HasColumnName(@"id").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<DingClass>().Property<string>(x => x.Class).HasColumnName(@"class").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<DingClass>().HasKey(@"Id");
        }

        partial void CustomizeDingClassMapping(ModelBuilder modelBuilder);
        ...
        #region ECSalesOrder Navigation properties
            ...
            modelBuilder.Entity<ECSalesOrder>().HasOne(x => x.SalesOrderAddress).WithMany(op => op.ECSalesOrders).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"AddressId");

        #endregion

        #region ECSalesOrderAddress Navigation properties

            modelBuilder.Entity<ECSalesOrderAddress>().HasMany(x => x.ECSalesOrders).WithOne(op => op.SalesOrderAddress).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"AddressId");
        ...
        #region ECShipBatch Navigation properties
            ...
            modelBuilder.Entity<ECShipBatch>().HasMany(x => x.PackingInfo).WithOne(op => op.ECShipBatch).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"OrderCode");
            modelBuilder.Entity<ECShipBatch>().HasMany(x => x.ProductInfo).WithOne(op => op.ECShipBatch).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"OrderCode");

        #endregion

        #region ECShipBatchPackingInfo Navigation properties

            modelBuilder.Entity<ECShipBatchPackingInfo>().HasOne(x => x.ECShipBatch).WithMany(op => op.PackingInfo).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"OrderCode");

        #endregion

        #region ECShipBatchProductInfo Navigation properties

            modelBuilder.Entity<ECShipBatchProductInfo>().HasOne(x => x.ECShipBatch).WithMany(op => op.ProductInfo).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"OrderCode");
        ...
        #region DingClassify Navigation properties

            modelBuilder.Entity<DingClassify>().HasMany(x => x.DingNews).WithOne(op => op.DingClassify).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"ClassifyId");
            modelBuilder.Entity<DingClassify>().HasOne(x => x.DingClass).WithMany(op => op.DingClassifies).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"ClassId");

        #endregion

        #region DingNew Navigation properties

            modelBuilder.Entity<DingNew>().HasOne(x => x.DingClassify).WithMany(op => op.DingNews).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"ClassifyId");

        #endregion

        #region OmsOrderList Navigation properties

            modelBuilder.Entity<OmsOrderList>().HasOne(x => x.FeeSummery).WithMany(op => op.OmsOrderLists).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"FeeSummeryId");
            modelBuilder.Entity<OmsOrderList>().HasMany(x => x.InventoryBatchOut).WithOne(op => op.OmsOrderList).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"OrderId");
            modelBuilder.Entity<OmsOrderList>().HasMany(x => x.Items).WithOne(op => op.OmsOrderList).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"OrderId");
            modelBuilder.Entity<OmsOrderList>().HasMany(x => x.OrderFee).WithOne(op => op.OmsOrderList).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"OrderId");

        #endregion

        #region OmsOrderListFeeSummery Navigation properties

            modelBuilder.Entity<OmsOrderListFeeSummery>().HasMany(x => x.OmsOrderLists).WithOne(op => op.FeeSummery).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"FeeSummeryId");

        #endregion

        #region OmsOrderListInventoryBatchOut Navigation properties

            modelBuilder.Entity<OmsOrderListInventoryBatchOut>().HasOne(x => x.OmsOrderList).WithMany(op => op.InventoryBatchOut).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"OrderId");

        #endregion

        #region OmsOrderListItem Navigation properties

            modelBuilder.Entity<OmsOrderListItem>().HasOne(x => x.OmsOrderList).WithMany(op => op.Items).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"OrderId");

        #endregion

        #region OmsOrderListOrderFee Navigation properties

            modelBuilder.Entity<OmsOrderListOrderFee>().HasOne(x => x.OmsOrderList).WithMany(op => op.OrderFee).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"OrderId");

        #endregion

        #region DingClass Navigation properties

            modelBuilder.Entity<DingClass>().HasMany(x => x.DingClassifies).WithOne(op => op.DingClass).OnDelete(DeleteBehavior.Cascade).IsRequired(false).HasForeignKey(@"ClassId");
