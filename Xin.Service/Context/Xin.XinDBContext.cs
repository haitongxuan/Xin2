...
namespace Xin.Service.Context
{
    ...
    public partial class XinDBContext : DbContext,IEntityContext
    {
        ...
        private void ECSalesOrderMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.IsPush).HasColumnName(@"is_push").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.CustomOrderType).HasColumnName(@"CustomOrderType").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.IsMark).HasColumnName(@"IsMark").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.CustomerServiceNote).HasColumnName(@"CustomerServiceNote").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.DiscountVal).HasColumnName(@"discount_val").HasColumnType(@"varchar(255)").ValueGeneratedNever().HasMaxLength(255);
