...
>>>>>>> e02549777bf86973191de76df0e15a5ceb859312
        ...
        private void BnsOmsReceivingCodeRecordMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BnsOmsReceivingCodeRecord>().Property<int?>(x => x.CreateUid).HasColumnName(@"CreateUid").ValueGeneratedNever();
            modelBuilder.Entity<BnsOmsReceivingCodeRecord>().Property<System.DateTime?>(x => x.CreateDate).HasColumnName(@"CreateDate").ValueGeneratedNever();
            modelBuilder.Entity<BnsOmsReceivingCodeRecord>().Property<int?>(x => x.WriteUid).HasColumnName(@"WriteUid").ValueGeneratedNever();
            modelBuilder.Entity<BnsOmsReceivingCodeRecord>().Property<System.DateTime?>(x => x.WriteDate).HasColumnName(@"WriteDate").ValueGeneratedNever();
            modelBuilder.Entity<BnsOmsReceivingCodeRecord>().Property<bool>(x => x.StopFlag).HasColumnName(@"StopFlag").IsRequired().ValueGeneratedNever().HasDefaultValueSql(@"false");
        ...
        private void ECAsnMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECAsn>().Property<int>(x => x.Id).HasColumnName(@"Id").IsRequired().ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity<ECAsn>().Property<string>(x => x.ReferenceNo).HasColumnName(@"ReferenceNo").ValueGeneratedNever().HasMaxLength(64);
            modelBuilder.Entity<ECAsn>().Property<int?>(x => x.IncomeType).HasColumnName(@"IncomeType").ValueGeneratedNever();
            modelBuilder.Entity<ECAsn>().Property<string>(x => x.WarehouseCode).HasColumnName(@"WarehouseCode").ValueGeneratedNever().HasMaxLength(64);
            modelBuilder.Entity<ECAsn>().Property<string>(x => x.TransitWarehouseCode).HasColumnName(@"TransitWarehouseCode").ValueGeneratedNever().HasMaxLength(64);
            modelBuilder.Entity<ECAsn>().Property<string>(x => x.SmCode).HasColumnName(@"SmCode").ValueGeneratedNever().HasMaxLength(64);
            modelBuilder.Entity<ECAsn>().Property<string>(x => x.ShippingMethod).HasColumnName(@"ShippingMethod").ValueGeneratedNever().HasMaxLength(64);
            modelBuilder.Entity<ECAsn>().Property<string>(x => x.TrackingNumber).HasColumnName(@"TrackingNumber").ValueGeneratedNever().HasMaxLength(128);
            modelBuilder.Entity<ECAsn>().Property<string>(x => x.ReceivingStatus).HasColumnName(@"ReceivingStatus").ValueGeneratedNever().HasMaxLength(64);
            modelBuilder.Entity<ECAsn>().Property<string>(x => x.ReceivingDesc).HasColumnName(@"ReceivingDesc").ValueGeneratedNever().HasMaxLength(1024);
            modelBuilder.Entity<ECAsn>().Property<System.DateTime?>(x => x.EtaDate).HasColumnName(@"EtaDate").ValueGeneratedNever();
            modelBuilder.Entity<ECAsn>().Property<System.DateTime?>(x => x.ReceivingModifyTime).HasColumnName(@"ReceivingModifyTime").ValueGeneratedNever();
            modelBuilder.Entity<ECAsn>().Property<int?>(x => x.RegionIdLevel0).HasColumnName(@"RegionIdLevel0").ValueGeneratedNever();
            modelBuilder.Entity<ECAsn>().Property<int?>(x => x.RegionIdLevel1).HasColumnName(@"RegionIdLevel1").ValueGeneratedNever();
            modelBuilder.Entity<ECAsn>().Property<int?>(x => x.RegionIdLevel2).HasColumnName(@"RegionIdLevel2").ValueGeneratedNever();
            modelBuilder.Entity<ECAsn>().Property<string>(x => x.Street).HasColumnName(@"Street").ValueGeneratedNever().HasMaxLength(256);
            modelBuilder.Entity<ECAsn>().Property<string>(x => x.Contacter).HasColumnName(@"Contacter").ValueGeneratedNever().HasMaxLength(256);
            modelBuilder.Entity<ECAsn>().Property<string>(x => x.ContactPhone).HasColumnName(@"ContactPhone").ValueGeneratedNever().HasMaxLength(64);
            modelBuilder.Entity<ECAsn>().Property<int?>(x => x.BoxTotal).HasColumnName(@"BoxTotal").ValueGeneratedNever();
            modelBuilder.Entity<ECAsn>().Property<int?>(x => x.SkuTotal).HasColumnName(@"SkuTotal").ValueGeneratedNever();
            modelBuilder.Entity<ECAsn>().Property<int?>(x => x.SkuSpecies).HasColumnName(@"SkuSpecies").ValueGeneratedNever();
            modelBuilder.Entity<ECAsn>().Property<System.DateTime?>(x => x.CalculateFeeTime).HasColumnName(@"CalculateFeeTime").ValueGeneratedNever();
        ...
        private void ECAsnItemMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECAsnItem>().Property<int>(x => x.Id).HasColumnName(@"Id").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<ECAsnItem>().Property<string>(x => x.ProductSku).HasColumnName(@"ProductSku").ValueGeneratedNever().HasMaxLength(128);
            modelBuilder.Entity<ECAsnItem>().Property<string>(x => x.ProductBarcode).HasColumnName(@"ProductBarcode").ValueGeneratedNever().HasMaxLength(128);
            modelBuilder.Entity<ECAsnItem>().Property<int?>(x => x.Quantity).HasColumnName(@"Quantity").ValueGeneratedNever();
            modelBuilder.Entity<ECAsnItem>().Property<int?>(x => x.ReceivedQuantity).HasColumnName(@"ReceivedQuantity").ValueGeneratedNever();
            modelBuilder.Entity<ECAsnItem>().Property<int?>(x => x.BoxNo).HasColumnName(@"BoxNo").ValueGeneratedNever();
            modelBuilder.Entity<ECAsnItem>().Property<int?>(x => x.PutawayQuantity).HasColumnName(@"PutawayQuantity").ValueGeneratedNever();
            modelBuilder.Entity<ECAsnItem>().Property<decimal?>(x => x.ProductPrice).HasColumnName(@"ProductPrice").ValueGeneratedNever();
            modelBuilder.Entity<ECAsnItem>().Property<int>(@"ECAsnId").HasColumnName(@"ECAsnId").ValueGeneratedNever();
        ...
        private void ECAsnCostMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECAsnCost>().Property<string>(x => x.CustomerCurrency).HasColumnName(@"CustomerCurrency").ValueGeneratedNever().HasMaxLength(32);
            modelBuilder.Entity<ECAsnCost>().Property<int>(@"ECAsnId").HasColumnName(@"ECAsnId").ValueGeneratedNever();
        ...
        private void ECAsnWarehouseAttrMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECAsnWarehouseAttr>().Property<int>(@"ECAsnItemId").HasColumnName(@"ECAsnItemId").ValueGeneratedNever();
        ...
        private void ECAsnProductCostMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECAsnProductCost>().Property<string>(x => x.CustomerCurrency).HasColumnName(@"CustomerCurrency").ValueGeneratedNever().HasMaxLength(32);
            modelBuilder.Entity<ECAsnProductCost>().Property<decimal?>(x => x.HeadCost).HasColumnName(@"HeadCost").ValueGeneratedNever();
            modelBuilder.Entity<ECAsnProductCost>().Property<int>(@"ECAsnItemId").HasColumnName(@"ECAsnItemId").ValueGeneratedNever();
        ...
        private void BnsUsBaseInventoryMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BnsUsBaseInventory>().Property<int>(x => x.Id).HasColumnName(@"Id").IsRequired().ValueGeneratedNever();
            ...
            modelBuilder.Entity<BnsUsBaseInventory>().Property<Xin.Entities.BnsUsTagType>(x => x.TagType).HasColumnName(@"TagType").IsRequired().ValueGeneratedNever().HasMaxLength(32);
        ...
        #region ECAsn Navigation properties
            ...
            modelBuilder.Entity<ECAsn>().HasMany(x => x.ECAsnCosts).WithOne(op => op.ECAsn).OnDelete(DeleteBehavior.Cascade).IsRequired(true).HasForeignKey(@"ECAsnId");
            modelBuilder.Entity<ECAsn>().HasMany(x => x.ECAsnItems).WithOne(op => op.ECAsn).IsRequired(true).HasForeignKey(@"ECAsnId");

        #endregion

        #region ECAsnItem Navigation properties

            modelBuilder.Entity<ECAsnItem>().HasOne(x => x.ECAsn).WithMany(op => op.ECAsnItems).IsRequired(true).HasForeignKey(@"ECAsnId");
            modelBuilder.Entity<ECAsnItem>().HasMany(x => x.ECAsnProductCosts).WithOne(op => op.ECAsnItem).IsRequired(true).HasForeignKey(@"ECAsnItemId");
            modelBuilder.Entity<ECAsnItem>().HasMany(x => x.ECAsnWarehouseAttrs).WithOne(op => op.ECAsnItem).IsRequired(true).HasForeignKey(@"ECAsnItemId");

        #endregion

        #region ECAsnCost Navigation properties

            modelBuilder.Entity<ECAsnCost>().HasOne(x => x.ECAsn).WithMany(op => op.ECAsnCosts).OnDelete(DeleteBehavior.Cascade).IsRequired(true).HasForeignKey(@"ECAsnId");

        #endregion

        #region ECAsnWarehouseAttr Navigation properties

            modelBuilder.Entity<ECAsnWarehouseAttr>().HasOne(x => x.ECAsnItem).WithMany(op => op.ECAsnWarehouseAttrs).IsRequired(true).HasForeignKey(@"ECAsnItemId");

        #endregion

        #region ECAsnProductCost Navigation properties

            modelBuilder.Entity<ECAsnProductCost>().HasOne(x => x.ECAsnItem).WithMany(op => op.ECAsnProductCosts).IsRequired(true).HasForeignKey(@"ECAsnItemId");
