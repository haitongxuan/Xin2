...
namespace Xin.Service.Context
{
    ...
    public partial class XinDBContext : DbContext,IEntityContext
    {
        ...
        public List<CwAccountQuerySpResult> CwAccountQuerySp ()
        {
        ...
        public async Task<List<CwAccountQuerySpResult>> CwAccountQuerySpAsync ()
        {
        ...
        private void ECSalesOrderMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECSalesOrder>().Property<int?>(@"DeliverId").HasColumnName(@"deliver_id").HasColumnType(@"int").ValueGeneratedNever();
        ...
        private void ECAliexpressLoaninfoMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECAliexpressLoaninfo>().Property<System.DateTime?>(x => x.LoanDate).HasColumnName(@"LoanDate").HasColumnType(@"datetime").ValueGeneratedNever();
            modelBuilder.Entity<ECAliexpressLoaninfo>().Property<string>(x => x.LoanType).HasColumnName(@"LoanType").HasColumnType(@"varchar(50)").ValueGeneratedNever().HasMaxLength(50);
            modelBuilder.Entity<ECAliexpressLoaninfo>().Property<string>(x => x.TransactionInfo).HasColumnName(@"TransactionInfo").HasColumnType(@"varchar(200)").ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECAliexpressLoaninfo>().Property<string>(x => x.PlateForm).HasColumnName(@"PlateForm").HasColumnType(@"varchar(50)").ValueGeneratedNever().HasMaxLength(50);
            modelBuilder.Entity<ECAliexpressLoaninfo>().Property<string>(x => x.FundsDetail).HasColumnName(@"FundsDetail").HasColumnType(@"varchar(200)").ValueGeneratedNever().HasMaxLength(200);
            modelBuilder.Entity<ECAliexpressLoaninfo>().Property<System.DateTime?>(x => x.Enterdate).HasColumnName(@"enterdate").HasColumnType(@"datetime").ValueGeneratedNever();
        ...
        #region ECSalesOrder Navigation properties
            ...
            modelBuilder.Entity<ECSalesOrder>().HasOne(x => x.BnsSendDeliverdToEc_DeliverId).WithMany(op => op.ECSalesOrders_DeliverId).IsRequired(false).HasForeignKey(@"DeliverId");
        ...
        #region BnsSendDeliverdToEc Navigation properties
            ...
            modelBuilder.Entity<BnsSendDeliverdToEc>().HasMany(x => x.ECSalesOrders_DeliverId).WithOne(op => op.BnsSendDeliverdToEc_DeliverId).IsRequired(false).HasForeignKey(@"DeliverId");
