...
// Code is generated on: 2020/3/6 11:10:22
//
...
namespace Xin.Service.Context
{
    ...
    public partial class XinDBContext : DbContext,IEntityContext
    {
        ...
        private void ECSkuRelationMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECSkuRelation>().Property<string>(x => x.WarehouseId).HasColumnName(@"WarehouseId").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
