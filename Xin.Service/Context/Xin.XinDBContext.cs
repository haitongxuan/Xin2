...
namespace Xin.Service.Context
{
    ...
    public partial class XinDBContext : DbContext,IEntityContext
    {
        ...
        private void BnsOmsReceivingCodeRecordMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BnsOmsReceivingCodeRecord>().Property<int>(x => x.Id).HasColumnName(@"Id").IsRequired().ValueGeneratedNever();
        ...
        private void ECAsnMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECAsn>().Property<int>(@"Id").HasColumnName(@"Id").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd();
        ...
        private void ECAsnItemMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECAsnItem>().Property<int>(@"Id").HasColumnName(@"Id").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd();
        ...
        #region ECAsn Navigation properties
            ...
            modelBuilder.Entity<ECAsn>().HasMany(x => x.ECAsnCosts).WithOne(op => op.ECAsn).IsRequired(false).HasForeignKey(@"ECAsnId");
            modelBuilder.Entity<ECAsn>().HasMany(x => x.ECAsnItems).WithOne(op => op.ECAsn).IsRequired(false).HasForeignKey(@"ECAsnId");

        #endregion

        #region ECAsnItem Navigation properties

            modelBuilder.Entity<ECAsnItem>().HasOne(x => x.ECAsn).WithMany(op => op.ECAsnItems).IsRequired(false).HasForeignKey(@"ECAsnId");
            modelBuilder.Entity<ECAsnItem>().HasMany(x => x.ECAsnProductCosts).WithOne(op => op.ECAsnItem).IsRequired(false).HasForeignKey(@"ECAsnItemId");
            modelBuilder.Entity<ECAsnItem>().HasMany(x => x.ECAsnWarehouseAttrs).WithOne(op => op.ECAsnItem).IsRequired(false).HasForeignKey(@"ECAsnItemId");

        #endregion

        #region ECAsnCost Navigation properties

            modelBuilder.Entity<ECAsnCost>().HasOne(x => x.ECAsn).WithMany(op => op.ECAsnCosts).IsRequired(false).HasForeignKey(@"ECAsnId");

        #endregion

        #region ECAsnWarehouseAttr Navigation properties

            modelBuilder.Entity<ECAsnWarehouseAttr>().HasOne(x => x.ECAsnItem).WithMany(op => op.ECAsnWarehouseAttrs).IsRequired(false).HasForeignKey(@"ECAsnItemId");

        #endregion

        #region ECAsnProductCost Navigation properties

            modelBuilder.Entity<ECAsnProductCost>().HasOne(x => x.ECAsnItem).WithMany(op => op.ECAsnProductCosts).IsRequired(false).HasForeignKey(@"ECAsnItemId");
