...
namespace Xin.Service.Context
{
    ...
    public partial class XinDBContext : DbContext,IEntityContext
    {
        ...
        private void ECSalesOrderMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.OldShippingMethod).HasColumnName(@"OldShippingMethod").HasColumnType(@"nvarchar(max)").ValueGeneratedNever();
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.OldShippingMethodNo).HasColumnName(@"OldShippingMethodNo").HasColumnType(@"nvarchar(max)").ValueGeneratedNever();
            ...
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.CustomOrderType).HasColumnName(@"CustomOrderType").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            ...
            modelBuilder.Entity<ECSalesOrder>().Property<string>(x => x.CustomerServiceNote).HasColumnName(@"CustomerServiceNote").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
