...
namespace Xin.Service.Context
{
    ...
    public partial class XinDBContext : DbContext,IEntityContext
    {
        ...
        private void ECProductMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECProduct>().Property<decimal?>(x => x.SuggestPrice).HasColumnName(@"SuggestPrice").ValueGeneratedNever();
        ...
        private void DingNewMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DingNew>().Property<int?>(x => x.Status).HasColumnName(@"status").HasColumnType(@"int").ValueGeneratedNever();
