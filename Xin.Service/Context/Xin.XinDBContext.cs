...
namespace Xin.Service.Context
{
    ...
    public partial class XinDBContext : DbContext,IEntityContext
    {
        ...
        public virtual DbSet<ECSkuRelationItems> ECSkuRelationItems
        {
            get;
            set;
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            this.ECSkuRelationItemsMapping(modelBuilder);
            this.CustomizeECSkuRelationItemsMapping(modelBuilder);
        ...
        private void ECSkuRelationMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ECSkuRelation>().Property<int>(x => x.Id).HasColumnName(@"Id").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<ECSkuRelation>().Property<string>(x => x.UserAccount).HasColumnName(@"UserAccount").ValueGeneratedNever();
            modelBuilder.Entity<ECSkuRelation>().Property<string>(x => x.ProductSku).HasColumnName(@"ProductSku").HasColumnType(@"nvarchar(4000)").ValueGeneratedNever().HasMaxLength(4000);
            modelBuilder.Entity<ECSkuRelation>().HasKey(@"Id");
        }
        ...
        #region ECSkuRelationItems Mapping

        private void ECSkuRelationItemsMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ECSkuRelationItems>().ToTable(@"EC_SkuRelationItems", @"dbo");
            modelBuilder.Entity<ECSkuRelationItems>().Property<int>(x => x.Id).HasColumnName(@"Id").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<ECSkuRelationItems>().Property<string>(x => x.PcrProductSku).HasColumnName(@"PcrProductSku").ValueGeneratedNever();
            modelBuilder.Entity<ECSkuRelationItems>().Property<string>(x => x.PcrQuantity).HasColumnName(@"PcrQuantity").ValueGeneratedNever();
            modelBuilder.Entity<ECSkuRelationItems>().Property<string>(x => x.WarehouseId).HasColumnName(@"WarehouseId").ValueGeneratedNever();
            modelBuilder.Entity<ECSkuRelationItems>().Property<string>(x => x.PcrPercent).HasColumnName(@"PcrPercent").ValueGeneratedNever();
            modelBuilder.Entity<ECSkuRelationItems>().Property<int?>(@"RelationItemId").HasColumnName(@"RelationItemId").ValueGeneratedNever();
            modelBuilder.Entity<ECSkuRelationItems>().HasKey(@"Id");
        }

        partial void CustomizeECSkuRelationItemsMapping(ModelBuilder modelBuilder);
        ...
        #region ECSkuRelation Navigation properties
            ...
            modelBuilder.Entity<ECSkuRelation>().HasMany(x => x.Relation).WithOne(op => op.ECSkuRelation).IsRequired(false).HasForeignKey(@"RelationItemId");

        #endregion

        #region ECSkuRelationItems Navigation properties

            modelBuilder.Entity<ECSkuRelationItems>().HasOne(x => x.ECSkuRelation).WithMany(op => op.Relation).IsRequired(false).HasForeignKey(@"RelationItemId");
